...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public UserResponse findPaginated(int pageNo, int pageSize, String sortBy) {
        Sort sortBy1 = Sort.by(Sort.Direction.ASC, sortBy);
        List<Users> listUser =  userRepository.findAll(sortBy1);
